...
# Kategorie danych - bubble

```{r, include = TRUE}
categories <- data.frame(table(all_data$category_name))
cat_viri <- viri2[1:nrow(categories)]

bubbles(value = categories$Freq, label = categories$Var1,
  color = cat_viri, textColor = "black")

```

# cokolwiek jeszcze

# TODO top 10 uzytkownikow/rok
# TODO top 10 tutulow/rok
# TODO top 10 organizacje/rok